...
function OpportunityPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setUserOpportunities(prevOpptunities => [...prevOpptunities, newOpportunity]);
        ...
        <div className="flex-2 bg-white w-2/4 pt-20 p-4">
          ...
          <div className="mt-8 text-left px-8">
            <div className="mt-8 flex flex-col space-x-4 justify-center">
              ...
              <MyOpportunitiesList userOpportunities={userOpportunities} setUserOpportunities={setUserOpportunities}/>
            </div>
          </div>
        </div>
